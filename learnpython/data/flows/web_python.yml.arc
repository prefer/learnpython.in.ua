title: Погружение в веб разработку на Python
active: 1
order: 1
...
* Что такое WSGI и зачем он нужен? Werkzeug и WebOb
* Работа с базами данных
* Тестирование
* Знакомство с django и pyramid для создания веб-приложений
* ORM's
* Шаблонизаторы

Курс состоит из двенадцати занятий. Лектор: **Телепенин Николай**
